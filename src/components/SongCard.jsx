...
//43:33 /*this div is gonna be dynamic so we are going to have template string */
// we have to figure out on hover if the song that is currently showing 
//is the song that is actively playing